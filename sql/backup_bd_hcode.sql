...
INSERT INTO `tb_persons` VALUES (1,'Administrador','nelton@masterpublica.com.br',31988630130,'2017-03-13 13:00:00'),(2,'Nelton Silva','neltonarsi@gmail.com',31988630130,'2017-03-13 13:10:27'),(3,'Erika Silva','neltonarsilva@gmail.com',31988150172,'2017-09-13 13:43:40'),(4,'Nilton Cesar','neltonarsi@hotmail.com',31997751794,'2017-09-13 13:50:02');
...
INSERT INTO `tb_users` VALUES (1,1,'admin','123',1,'2017-03-13 13:00:00'),(2,2,'nelton','123',1,'2017-03-13 13:10:27'),(3,3,'neltonarsilva@gmail','123',0,'2017-09-13 13:43:40'),(4,4,'neltonarsi@hotmail','123',0,'2017-09-13 13:50:02');
...
INSERT INTO `tb_userspasswordsrecoveries` VALUES (1,2,'127.0.0.1',NULL,'2017-03-15 16:10:59'),(2,3,'127.0.0.1','2017-03-15 13:33:45','2017-03-15 16:11:18'),(3,4,'127.0.0.1','2017-03-15 13:37:35','2017-03-15 16:37:12'),(4,2,'127.0.0.1',NULL,'2017-09-06 13:44:34'),(5,4,'127.0.0.1','2017-09-06 10:45:54','2017-09-06 13:45:28');
...
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_addresses_save`(
pidaddress int(11), 
pidperson int(11),
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_carts_save`(
pidcart INT,
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_categories_save`(
pidcategory INT,
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_orders_save`(
pidorder INT,
pidcart int(11),
piduser int(11),
pidstatus int(11),
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_products_save`(
pidproduct int(11),
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_userspasswordsrecoveries_create`(
piduser INT,
pdesip VARCHAR(45)
)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_usersupdate_save`(
piduser INT,
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_users_delete`(
piduser INT
)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Nelton`@`localhost` PROCEDURE `sp_users_save`(
pdesperson VARCHAR(64), 
pdeslogin VARCHAR(64), 
pdespassword VARCHAR(256), 
pdesemail VARCHAR(128), 
