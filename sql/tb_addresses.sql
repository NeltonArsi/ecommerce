...
CREATE TABLE `tb_addresses` (
  ...
  `deszipcode` int(11) NOT NULL,
  `desdistrict` varchar(32) NOT NULL,
  `dtregister` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`idaddress`),
  KEY `fk_addresses_user_idx` (`iduser`),
  CONSTRAINT `fk_addresses_user` FOREIGN KEY (`iduser`) REFERENCES `tb_users` (`iduser`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tb_addresses` VALUES (1,5,'Rua Serra Geral','156','','Ipatinga','MG','Brasil',35164236,'Jardim Panorama','2020-06-19 01:04:11'),(2,4,'Rua Joaquim Valadares','230','','Itabira','MG','Brasil',35900105,'Bela Vista','2020-06-19 01:12:34'),(3,6,'Rua dos Caetés','351','','Ipatinga','MG','Brasil',35162038,'Iguaçu','2020-06-19 01:27:04');
...
BEGIN
    ...
    INSERT INTO tb_users (desperson, desemail, deslogin, despassword, inadmin, nrphone)
    VALUES(pdesperson, pdesemail, pdeslogin, pdespassword, pinadmin, pnrphone);
...
-- Dump completed on 2020-06-19 12:04:01
