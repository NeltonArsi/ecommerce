								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<div class="col-md-4">
												<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
													<input type="radio" id="boleto" name="payment-method" placeholder="País" value="1" style="float:left; margin: 30px;">
											...
											<div id="payment">
												<div class="form-row place-order">
													<input type="submit" data-value="Place order" value="Continuar" id="place_order" name="woocommerce_checkout_place_order" style="margin-top: 30px; "class="button alt">
												</div>
												<div class="clear"></div>
											</div>
										</div>
