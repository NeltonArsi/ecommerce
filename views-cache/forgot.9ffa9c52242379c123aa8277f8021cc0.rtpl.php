                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Para redefinir sua senha acesse o link <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Entre em contato</b></a> se tiver alguma dúvida ou sugestão.
          </div>
        </td>
        <td></td>
      </tr>
