    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <?php } ?>                
                <form method="post" action="/profile/address/<?php echo htmlspecialchars( $address["idaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
					<h3>Endereço</h3>
				        <div class="box-body">
				            <div class="form-group" class="form-row form-row-wide address-field validate-required">
								...
								<input type="submit" value="Atualizar CEP" id="place_order" class="button alt" formaction="/profile/address/<?php echo htmlspecialchars( $address["idaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" formmethod="get">
							</div>
